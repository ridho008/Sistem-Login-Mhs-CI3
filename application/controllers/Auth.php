	...
	private function _login()
	{
		...
		if($user != null) {
			...
			if($user['is_active'] == 1) {
				...
				// kalau gagal atau nilai 0
				$this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">This email has not bin activated!</div>');
				redirect('auth');
			}
		} else {
			// apabila emailnya belum di register
